...
class Scene32(QWidget):
    ...
    def _initImageLoad(self):
        ...
        self.servive_step2 = ImageLoader(parent=self, geo=[1360, 375, 443, 150],
        ...
        self.servive_step2.tag_label.setWordWrap(True)
        self.servive_step3 = ImageLoader(parent=self, geo=[908, 420, 650, 200],
                                         image_url='./images_test3/computing_power_addressing_step3.png',
                                         img_scale_w=650,
                                         img_scale_h=200,
                                         direction="r2l",
                                         interval=3, title='3.心跳检测处理实例化', tag_geo=[100, 0, 400, 20])
        self.servive_step4 = ImageLoader(parent=self, geo=[880, 550, 475, 170],
