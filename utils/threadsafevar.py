...
class RemoteManagerValue:
    """
    Add a get_value() method to Value class. This enables it to be used with
    multiprocessing.manager for remote state sharing.
    """

    def __init__(self, t: str = 'i', v: int = 0):
        self.v = Value(t, v)
